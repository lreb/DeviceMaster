<?php 
	...
	$r = $db->query("SELECT * FROM products WHERE CategoryRf = 1;");	
...
?>
<br>
		<input type="hidden" name="" id="sectionRf" value="1" placeholder="">
<div class="row">
	<div class="col-md-12">
			...
			?>
				...
				<div class="row">
					<div class="form-group col-md-3">
							<img src="../../img/Escritorio/<?php echo $x['Image']; ?>" alt=""/ style="">
					</div>	
